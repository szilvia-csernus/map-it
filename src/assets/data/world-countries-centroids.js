// original dataset is from https://github.com/gavinr/world-countries-centroids/blob/master/dist/countries.geojson - MIT Licence, Copyright (c) 2021 Gavin Rehkemper

// Changes:
// Data structure has been customised, unneccessary data has been dropped.
...
export const countryCoordinates = {
	...
	XS: {
		...
		coordinates: [33.017167, 34.57704],
	},
	AS: {
	...
	AX: {
		...
		coordinates: [19.94688, 60.223532],
	},
	UM: {
