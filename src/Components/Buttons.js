...
import { addTouchLayer, addHoverLayer, addBlurLayer, addDesktopEventListeners } from '../js/map-layers';
...
export const OneRegionBtn = forwardRef((props, ref) => {
	...
	function clickHandler() {
        ...
        dispatch(gameActions.removeChooseRegionTitle(gameState));
        dispatch(gameActions.removeRegionBtns(gameState))
